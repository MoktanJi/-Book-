    ...
    return (
            <div className='add-form-page'>
                ...
                <div className="add-form-container m-4">
                    ...
                    <div class=" form-group col-md-4 my-4">
                        <label for="formFileMultiple" class="form-label">Upload Photo of Book Cover</label>
                        <input class="form-control" accept='.jpg , .png' type="file" id="formFileMultiple" multiple />
                    </div>
